...
from backend.components.interfaces import Chunker, Embedding
from backend.components.types import InputConfig


class SemanticChunker(Chunker):
    """
    SemanticChunker for Ragit based on https://github.com/FullStackRetrieval-com/RetrievalTutorials/blob/main/tutorials/LevelsOfTextSplitting/5_Levels_Of_Text_Splitting.ipynb
    """
