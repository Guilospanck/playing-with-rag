...
from backend.components.embedding.OllamaEmbedder import get_models
from backend.components.interfaces import Generator
from backend.components.types import InputConfig
from backend.server.types import GeneratorResult
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.post(
                    urljoin(self.url, "/api/chat"), json=data
                ) as response:
