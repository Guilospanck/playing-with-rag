...
# Import Embedders
from backend.components.embedding.OllamaEmbedder import OllamaEmbedder

# Import Generators
from backend.components.generation.OllamaGenerator import OllamaGenerator
...
from backend.components.reader.GitReader import GitReader

# Import Retrievers
from backend.components.retriever.WindowRetriever import WindowRetriever
from backend.server.helpers import LoggerManager
from backend.server.types import FileConfig, FileStatus, GeneratorResult
...
class EmbeddingManager:
    ...
    async def vectorize(
        ...
        @parameter: documents : Document - Ragit document
