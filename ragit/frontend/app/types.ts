...
export const LightTheme: Theme = {
  theme_name: "Light",
  title: { text: "Ragit", type: "text", description: "Title" },
  subtitle: {
  ...
  intro_message: {
    text: "Welcome to Ragit, your open-source RAG application!",
    type: "text",
...
export const DarkTheme: Theme = {
  ...LightTheme,
  theme_name: "Dark",
  title: { ...LightTheme.title, text: "Ragit" },
...
export const WCDTheme: Theme = {
  ...
  image: {
    ...LightTheme.image,
    src: "https://github.com/weaviate/Ragit/blob/1.0.0/frontend/public/weaviate.png?raw=true",
  },
