...
const GettingStartedComponent: React.FC<GettingStartedComponentProps> = ({
  ...
  const handleGetStarted = () => {
    ...
    setShouldShow(false);
    addStatusMessage("Achievement unlocked: Welcome to Ragit!", "SUCCESS");
  };
          ...
          <div className="hero-content flex-row">
            <div className="text-center lg:text-left">
              ...
              <p className="py-6 text-sm md:text-base">
                Ragit is an open-source application designed to offer an
              ...
              <p className="py-6 text-sm md:text-base">
                ...
                our video on Ragit. Ragit is currently still in development. If
            ...
            <div className="hidden md:block shrink-0">
              <img
                src="https://raw.githubusercontent.com/weaviate/Ragit/main/img/thumbnail.png"
                alt="Ragit AI"
                width={400}
